...
struct PrivacyView: View {
    ...
    private let sections: [Section] = [
        Section(heading: "1. 수집하는 개인정보 항목", body: [
            ...
            "서비스는 무료로 제공하기 위해 웹(Google AdSense)과 모바일 앱(Google AdMob)에 광고를 게재하며, 이 과정에서 Google LLC가 위 광고 관련 정보를 자동으로 수집합니다. 서비스는 이 정보를 자체 서버에 저장하지 않습니다. 모바일 앱은 이용자 추적 권한(App Tracking Transparency)을 요청하지 않으므로 광고 식별자(IDFA)는 수집하지 않습니다.",
        ]),
